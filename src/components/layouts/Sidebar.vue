...
<template>
  ...
  <button
    type="button"
    class="fixed left-4 top-4 z-40 grid h-11 w-11 place-items-center rounded-2xl border border-[#64CCC9]/20 bg-white/95 text-[#00313C] -[#00313C]/10 lg:hidden"
  ...
  <div
    v-if="mobileOpen"
    class="fixed inset-0 z-40 bg-[#00313C]/60 lg:hidden"
  ...
  <aside
    class="fixed inset-y-0 left-0 z-50 flex w-[280px] flex-col overflow-hidden border-r border-white/10 bg-[#00313C] px-4 py-5 text-white -[#00313C]/20 transition-transform duration-300 lg:translate-x-0"
  ...
  >
    ...
    <div class="relative flex h-full flex-col">
      ...
      <!-- <div
        class="mx-1 mb-7 rounded-3xl border border-white/10 bg-white/[0.07] p-3 -black/10"
      >
      ...
      >
        ...
        <button
          ...
          :class="isActive(item.href) ? 'bg-white text-[#00313C] -black/10' : 'text-white/65 hover:bg-white/10 hover:text-white'"
