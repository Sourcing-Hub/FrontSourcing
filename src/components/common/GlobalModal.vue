    ...
    >
      ...
      <div class="mt-6 flex justify-end gap-3">
        ...
        <button 
          ...
          @click="store.cancel"
          class="px-4 py-2 border border-gray-200 text-gray-700 bg-white hover:bg-gray-50 text-xs font-semibold rounded-xl -xs transition-colors"
        >
          {{ store.cancelText }}
        </button>
        ...
        <button 
          @click="store.accept"
          class="px-4 py-2 text-white text-xs font-semibold rounded-xl -xs transition-colors"
