...
<template>
  ...
  <article
    class="group flex flex-col gap-5 rounded-3xl border border-[#00313C]/20 bg-white p-5  backdrop-blur transition duration-300 hover:-translate-y-1 hover:border-[#00313C]/40  sm:flex-row sm:items-center sm:justify-between"
  >
