...
<template>
  ...
  <article
    class="group flex flex-col gap-5 rounded-3xl border border-[#00313C]/20 bg-white p-5 transition duration-300 hover:-translate-y-1 hover:border-[#00313C]/40 sm:flex-row sm:items-center sm:justify-between"
  >
    ...
    <div class="flex min-w-0 items-center gap-4">
      ...
      <!--  Structure un groupe d’éléments visuels. -->
      <div
        class="grid h-16 w-16 shrink-0 place-items-center rounded-3xl bg-[#E40046] text-white"
      >
      ...
      <div class="min-w-0">
        ...
        <div class="flex flex-wrap items-center gap-2">
          ...
          <span
            ...
            :class="{ 'bg-[#00313C]/10 text-[#00313C]': interview.status === 'En-attente', 'bg-[#00313C]/20 text-[#00313C]': interview.status === 'progress', 'bg-[#00313C]/5 text-[#00313C]/60': interview.status === 'completed', }"
          >
            <!--  Affiche une donnée dynamique dans l’interface. -->
