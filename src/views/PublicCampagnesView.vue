...
<template>
  <div class="min-h-screen bg-slate-50/50 text-slate-800 font-sans flex flex-col relative overflow-hidden">
    ...
    <div class="absolute top-0 right-0 -z-10 translate-x-1/3 -translate-y-1/4 w-[600px] h-[600px] rounded-full bg-[#CE0033]/5 -[120px] pointer-events-none"></div>
    <div class="absolute top-1/2 left-0 -z-10 -translate-x-1/3 w-[500px] h-[500px] rounded-full bg-[#00313C]/5 -[100px] pointer-events-none"></div>

    <!-- Header Navbar -->
    <header class="bg-white/80 border-b border-slate-100 sticky top-0 z-50">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
        ...
        <div class="flex items-center gap-3">
          <button
            ...
            class="inline-flex items-center gap-2 px-5 py-2.5 rounded-full text-sm font-bold text-[#00313C] bg-slate-100 hover:bg-[#CE0033] hover:text-white transition-all duration-300 -xs"
          >
            <LogIn class="w-4 h-4" />
    ...
    <section class="relative pt-12 pb-16 lg:pt-20 lg:pb-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full text-center">
      ...
      <div class="mt-10 max-w-2xl mx-auto">
        <div class="relative flex items-center -slate-200/60 rounded-2xl bg-white border border-slate-200 focus-within:border-[#CE0033] focus-within:ring-2 focus-within:ring-[#CE0033]/20 transition-all">
        ...
        >
          ...
          <div class="p-6 pt-0">
            <button
              ...
              class="w-full flex items-center justify-center py-3.5 px-4 bg-[#CE0033] hover:bg-[#a8002a] text-white rounded-2xl transition-all duration-200 font-extrabold -[#CE0033]/20 -[#CE0033]/30 gap-2 text-sm"
            >
