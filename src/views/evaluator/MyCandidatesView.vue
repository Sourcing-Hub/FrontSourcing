...
<template>
  <main class="min-h-screen bg-[#F8FBFC] px-5 py-20 lg:px-10 lg:py-10">
    ...
    <section class="mb-6 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
      <article class="rounded-3xl border border-[#00313C]/20 bg-white p-5 -[#00313C]/5">
      ...
      <article class="rounded-3xl border border-[#00313C] bg-[#00313C] p-5 text-white -[#00313C]/5">
      ...
      <article class="rounded-3xl border border-[#00313C]/30 bg-white p-5 -[#00313C]/5">
    ...
    <section class="mb-6 grid gap-3 rounded-3xl border border-[#00313C]/20 bg-white p-3 -[#00313C]/5 xl:grid-cols-[1fr_210px_190px_190px_auto]">
    ...
    <div
      v-if="loading"
      class="rounded-3xl border border-[#00313C]/20 bg-white/80 py-20 text-center text-sm font-bold text-[#00313C]/50 -[#00313C]/5"
    >
      Chargement...
    </div>
    ...
    <div
      ...
      class="grid gap-6"
    >
      <section class="rounded-3xl border border-[#00313C]/20 bg-white/90 p-4 -[#00313C]/5 lg:p-6">
        <div class="mb-5">
        ...
        >
          ...
          <button
            ...
            :class="currentCandidatePage === page ? 'bg-[#00313C] text-white ' : 'border border-[#00313C]/20 bg-white text-[#00313C] hover:border-[#00313C] hover:bg-[#00313C]/5'"
