...
<template>
  ...
  >
    ...
    <button
      type="button"
      class="mb-6 inline-flex h-11 items-center rounded-2xl border border-[#00313C]/25 bg-white px-4 text-sm font-black text-[#00313C] -[#00313C]/7 transition-all duration-200 hover:-translate-y-0.5 hover:border-[#E40046]/30 hover:bg-[#E40046] hover:text-white -[#E40046]/2 focus:outline-none focus:ring-4 focus:ring-[#00313C]/30 active:scale-[0.98]"
      @click="goBack"
    >
      ← Mes candidats
    ...
    <div
      v-if="loading"
      class="rounded-3xl border border-[#00313C]/20 bg-white py-20 text-center text-sm font-bold text-[#00313C]/50 -[#00313C]/2"
    >
    ...
    <template v-else-if="candidate">
      ...
      <section
        class="mt-6 rounded-[2rem] border border-[#00313C]/20 bg-white p-5 -[#00313C]/3"
      >
