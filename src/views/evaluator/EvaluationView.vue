...
<template>
  ...
  >
    ...
    <div
      v-if="loading"
      class="rounded-3xl border border-[#64CCC9]/20 bg-white py-20 text-center -[#00313C]/1"
    >
      <p
            ...
            >
              ...
              >
                ...
                <button
                  ...
                  :class="Number( notes[String(question.id)] ) >= note ? 'border-[#E40046] bg-[#E40046] text-white' : 'border-[#E40046]/20 bg-white text-[#E40046] hover:border-[#E40046]/50 hover:bg-[#E40046]/10'"
                  @click="
                    setNote(
                      question.id,
                      note
