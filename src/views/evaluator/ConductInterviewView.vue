...
<template>
  ...
  >
    ...
    <div
      v-if="loading"
      class="rounded-3xl border border-[#00313C]/20 bg-white py-20 text-center text-sm font-bold text-[#00313C]/50 -[#00313C]/1"
    >
    ...
    <template v-else>
      ...
      >
        ...
        >
          ...
          <button
            type="button"
            class="m-5 h-12 w-[calc(100%-2.5rem)] rounded-2xl bg-[#E40046] text-sm font-black text-white transition-all duration-200 hover:bg-[#00313C] -[#00313C]/1 focus:outline-none focus:ring-4 focus:ring-[#00313C]/30 active:scale-[0.98]"
          >
            <!--  Affiche ce contenu textuel dans la vue évaluateur. -->
            Consulter le CV
