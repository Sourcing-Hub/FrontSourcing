  ...
  <DashboardLayout>
    ...
    <div class="space-y-6">
      ...
      <div v-if="authStore.user?.role !== 'Candidat'" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <!-- Total -->
        <div class="bg-white p-5 rounded-2xl border border-gray-200/70 -xs flex items-center justify-between">
          <div>
      ...
      <div v-if="authStore.user?.role !== 'Candidat'" class="bg-white rounded-2xl -xs border border-gray-200/80 p-5 space-y-4">
        ...
        <div class="flex flex-col sm:flex-row gap-3 items-stretch sm:items-center justify-between border-b border-gray-100 pb-4">
          ...
          <div class="flex items-center gap-2">
            <button
              @click="handleSearch"
              class="px-5 py-2.5 bg-[#CE0033] hover:bg-[#a8002a] text-white rounded-xl text-sm font-semibold transition-all -xs flex items-center justify-center gap-2"
            >
      ...
      <div class="bg-white rounded-2xl -xs border border-gray-200/80 overflow-hidden min-w-0">
        <!-- Spinner Chargement -->
        ...
        <div v-else-if="authStore.user?.role === 'Candidat'" class="p-6 grid grid-cols-1 lg:grid-cols-3 gap-8">
          <!-- Carte Badge QR Code -->
          <div class="border border-gray-200/80 rounded-2xl p-6 flex flex-col items-center justify-between text-center -xs h-full">
            <div>
            ...
            <button
              ...
              class="w-full mt-4 flex items-center justify-center gap-2 px-4 py-2.5 border border-gray-200 text-gray-700 bg-white hover:bg-gray-50 disabled:opacity-50 text-xs font-bold rounded-xl -xs transition-all"
            >
