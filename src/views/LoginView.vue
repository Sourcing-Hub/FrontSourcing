...
<template>
  <div class="min-h-screen flex flex-col lg:flex-row">
    ...
    >
      ...
      <div
        class="absolute -top-40 -right-40 w-96 h-96 bg-[#CE0033]/10 rounded-full filter opacity-40 animate-blob"
      ></div>
      <div
        class="absolute -bottom-40 -left-40 w-96 h-96 bg-[#002B35]/10 rounded-full filter opacity-30 animate-blob animation-delay-2000"
      ></div>
      ...
      <div class="max-w-md w-full bg-white rounded-3xl border border-gray-100 p-8 sm:p-10 space-y-6 relative z-10">
        ...
        <form @submit.prevent="handleLogin" class="space-y-4 pt-1">
          ...
          <button
            ...
            class="w-full py-3.5 px-4 bg-[#002B35] hover:bg-[#001D24] text-white text-sm font-extrabold rounded-xl -xs transition-all duration-200 flex items-center justify-center gap-2"
          >
          ...
          <button
            type="button"
            @click="openResetModal()"
            class="w-full py-3 px-4 border border-gray-200 bg-white hover:bg-gray-50 text-gray-700 text-xs font-semibold rounded-xl transition-all flex items-center justify-center gap-2 -2xs"
          >
    ...
    <div
      v-if="showResetModal"
      class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-gray-900/60 -xs transition-opacity"
    >
