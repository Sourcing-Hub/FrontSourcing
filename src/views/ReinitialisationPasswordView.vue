    ...
    <div class="max-w-md w-full bg-white rounded-3xl border border-gray-100 p-8 sm:p-10 space-y-6">
      ...
      <form v-else @submit.prevent="handleSubmit" class="space-y-4">
        ...
        <button
          type="submit"
          :disabled="loading"
          class="w-full py-3.5 px-4 bg-[#002B35] hover:bg-[#001D24] text-white text-xs font-bold rounded-xl -xs transition-colors flex items-center justify-center gap-2"
        >
